...
{
    class Administrador : Tabela<Administrador>
    {
        private string tabela = "administrador";
        ...
        public void Editar(int id, Administrador valor)
        {
        ...
        public void Inserir(Administrador valor)
        {
            List<string> valores = new List<string>();
            valores.Add(valor.Nome);
            valores.Add(Convert.ToString(valor.FuncionarioId));
